package com.amaris.movies.util
...
import com.amaris.movies.movielist.Popularity
...
private fun getAssociatedColor(popularity: Popularity, context: Context): Int {
    return when(popularity) {
        ...
        Popularity.POPULAR -> ContextCompat.getColor(context, R.color.pink)
        Popularity.STAR -> ContextCompat.getColor(context, R.color.red)
    }
}
...
private fun getDrawablePopularity(popularity: Popularity, context: Context): Drawable? {
    return when (popularity) {
        Popularity.NORMAL -> {
            ContextCompat.getDrawable(context, androidx.core.R.drawable.ic_call_answer)
        }
        Popularity.POPULAR -> {
            ContextCompat.getDrawable(context, androidx.core.R.drawable.ic_call_answer_video)
        }
        Popularity.STAR -> {
            ContextCompat.getDrawable(context, com.google.android.material.R.drawable.ic_clock_black_24dp)
        }
    }
}